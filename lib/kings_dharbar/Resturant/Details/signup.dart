...
import 'package:kings_dharbar1/kings_dharbar/Resturant/Details/signin.dart';
import 'package:kings_dharbar1/kings_dharbar/User/Details/custom_shape.dart';
 ...
 bool _autovalidate = false;
                ...
                Opacity(opacity: 0.88,child: AppBar(
                        leading: IconButton(
                              icon: Icon(Icons.arrow_back,color: Colors.white),
                                 onPressed: () {
                                   Navigator.push(
                                       context, MaterialPageRoute(builder: (_) => ResturantSignin()));
                                 },
                                ),
  ...
  _submitDetails() {
    if (_formKey.currentState!.validate()) {
      ...
      ref.child('Restaurant user').push().set(data).then((v) {
